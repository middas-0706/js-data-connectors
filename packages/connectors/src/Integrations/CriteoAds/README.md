The [**Criteo Connector**](.) allows you to transfer raw data from Criteo advertising services into Google Sheets. Use this data for in-depth analysis and reporting.
