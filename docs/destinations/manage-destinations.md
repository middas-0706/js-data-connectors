...
Supported destinations include **Google Sheets**, **Microsoft Excel**, **Data Studio**, **Email**, **Slack**, **Microsoft Teams**, and **Google Chat**. In the near future, we will add support for OData-compatible tools like Tableau and Power BI.
