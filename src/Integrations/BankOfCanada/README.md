The [**Bank of Canada Connector**](https://github.com/OWOX/js-data-connectors/tree/main/src/Integrations/BankOfCanada) allows you to transfer exchange rates from Bank of Canada into Google Sheets. 
